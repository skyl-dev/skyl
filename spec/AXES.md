...
`android/db` covers persistence — what is stored, what survives, what is encrypted at rest —
whether the project uses Room, DataStore, or files. It is not `android/room`.
